...
import { push } from "@/api/system/user";
...
<template>
  <ElDialog v-model="dailogVisible" width="450px" :title="formData.id ? '修改' : '添加'">
    <ElForm :model="formData" ref="formRef" label-width="80px">
      <ElFormItem
        ...
        <ElInput v-model="formData.nickname" placeholder="请输入昵称" style="width: 220px" />
      </ElFormItem>
      <ElFormItem
        label="账号"
        prop="account"
        ...
        <ElInput v-model="formData.account" placeholder="请输入账号" style="width: 220px" />
      </ElFormItem>
      <ElFormItem
        label="角色"
        prop="system_role_id"
      ...
      <ElFormItem
        ...
        <ElInput v-model="formData.password" placeholder="请输入密码" type="password" style="width: 250px"></ElInput>
      </ElFormItem>
      <ElFormItem
        label="确认密码"
